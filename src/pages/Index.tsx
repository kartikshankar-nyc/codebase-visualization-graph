    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="flex-grow flex">
        ...
        <div className="w-80 border-r border-border bg-card flex flex-col overflow-hidden">
            ...
            {rootPath ? (
              ...
              <div className="text-center py-8 text-muted-foreground">
                <div className="mb-2">
                  ...
                  Select a folder to visualize or use the sample data
                </div>
                <button
          ...
          {/* Selected file info */}
          {selectedItem && (
            <div className="p-3 border-t border-border bg-secondary/50 animate-slide-in">
              <div className="text-sm font-medium mb-1 truncate">{selectedItem.split('/').pop()}</div>
        ...
        <div className="flex-grow flex flex-col relative">
          {/* Graph controls */}
          <div className="z-10 p-3 flex items-center justify-between border-b border-border bg-card/80 backdrop-blur-sm">
                ...
                <MiniMap 
                  nodeColor={(node) => {
                    switch (node.data?.type) {
                      case 'file': return 'hsl(var(--primary) / 0.3)';
                      case 'folder': return 'hsl(var(--primary) / 0.6)';
                      default: return 'hsl(var(--muted) / 0.6)';
                    }
                  }}
              ...
              <div className="flex items-center justify-center h-full">
                {isLoading ? (
                  <div className="text-center animate-pulse">
                    <div className="w-16 h-16 mx-auto mb-4 rounded-full border-4 border-t-primary border-r-transparent border-b-transparent border-l-transparent animate-spin"></div>
                    <p className="text-muted-foreground">Processing codebase...</p>
                  </div>
                ) : (
                  <div className="text-center max-w-md p-8">
                    <div className="flex flex-col items-center justify-center mb-6">
                      <Code size={40} className="text-muted-foreground mb-4" />
                      <h2 className="text-xl font-medium mb-2">No Codebase Loaded</h2>
                      <p className="text-muted-foreground text-sm mb-6">
                        Select a folder to visualize your codebase or use our sample data to explore the features.
                      </p>
                      ...
                      <div className="flex space-x-4">
                        ...
                        <button
                          className="py-2 px-4 border border-border rounded-md hover:bg-secondary transition-colors"
                          onClick={loadSampleData}
                        >
                          Try Sample Data
                        </button>
                    ...
                    <div className="grid grid-cols-3 gap-5 text-center">
                      ...
                      <div className="p-4 rounded-lg bg-card border border-border">
                        <Box size={20} className="mx-auto mb-2 text-purple-500" />
      ...
      {/* Footer */}
      <footer className="py-2 px-4 bg-card border-t border-border text-xs text-muted-foreground flex justify-between items-center">
        <div>
          <span className="inline-flex items-center">
            <Info size={12} className="mr-1" /> 
            Visualizing dependencies across your codebase
          </span>
        </div>
        
        <div className="inline-flex items-center">
          <button
            className="p-1 rounded hover:text-foreground transition-colors mr-2"
            onClick={exportDependencies}
          ...
          <button
            className="p-1 rounded hover:text-foreground transition-colors ml-2"
            onClick={centerGraph}
            title="Reset View"
          >
